 ...
 */
const INTERNAL_DEFS = [passthrough, macroIn, macroOut];
/** The palette-visible definitions, in palette order. */
export const paletteDefs = PALETTE_DEFS;
/** Every definition the engine can dispatch over, keyed by node type. */
export const REGISTRY = Object.fromEntries([...PALETTE_DEFS, ...INTERNAL_DEFS].map((d) => [d.type, d]));
